...
# (str) Package name
package.name = nowinkivy

# (str) Package domain (needed for android/ios packaging)
package.domain = com.simplejnius.samples.app
...
source.exclude_dirs = tests, bin, venv, .venv, cache
...
requirements = python3==3.11.11,hostpython3==3.11.11,kivy,kvdroid,sjbillingclient,
    sdl2==2.30.11,sdl2_mixer==2.8.0,sdl2_ttf==2.24.0,sdl2_image==2.8.4,libffi==v3.4.6,
...
android.gradle_dependencies = androidx.appcompat:appcompat:1.7.0,com.android.billingclient:billing:7.1.1
...
build_dir = /home/kengo/PycharmProjects/now-in-kivy/.buildozer
